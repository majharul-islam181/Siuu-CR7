...
abstract class $TvShowsCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'image_thumnail_path') String imageThumbnailPath,
...
class _$TvShowsImpl implements _TvShows {
  _$TvShowsImpl(
      ...
      @JsonKey(name: 'image_thumnail_path') this.imageThumbnailPath = '',
...
abstract class _TvShows implements TvShows {
  factory _TvShows(
      ...
      @JsonKey(name: 'image_thumnail_path') final String imageThumbnailPath,
